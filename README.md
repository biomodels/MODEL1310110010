# MODEL1310110010: MODEL1310110010
...
`pip install git+https://github.com/biomodels/MODEL1310110010.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110010.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110010 as model`
...
The model of lung pneumocytes metabolism is derived from the community-driven
...
and identified by:
[MODEL1310110010](http://identifiers.org/biomodels.db/MODEL1310110010) .
